...
CREATE TABLE `housedeal` (
    ...
    KEY `housedeal_apt_code_houseinfo_apt_code_fk_idx` (`apt_code`), 
    CONSTRAINT `housedeal_apt_code_houseinfo_apt_code_fk` FOREIGN KEY (`apt_code`) REFERENCES `houseinfo` (`apt_code`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `houseinfo` (
    ...
    `si_gun_gu_code` varchar(5) DEFAULT NULL, 
    ...
    UNIQUE KEY `UNIQUE` (`build_year`, `apartment_name`, `jibun`, `si_gun_gu_code`, `eub_myun_dong_code`) /*!80000 INVISIBLE */, 
    KEY `houseinfo_dong_code_dong_dong_code_fk_idx` (`dong_code`) /*!80000 INVISIBLE */, 
...
CREATE TABLE `UserInfo` (
    ...
    `user_favorite_place` VARCHAR(45) NULL, 
    PRIMARY KEY (`user_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `Comment` (
    ...
    KEY `Comment_post_id_DongStory_post_id_fk_idx` (`post_id`), 
    CONSTRAINT `Comment_post_id_DongStory_post_id_fk` FOREIGN KEY (`post_id`) REFERENCES `DongStory` (`post_id`),
    KEY `Comment_user_id_userinfo_user_id_fk_idx` (`user_id`),
    CONSTRAINT `Comment_user_id_userinfo_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `userinfo` (`user_id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;